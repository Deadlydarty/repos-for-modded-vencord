/**
 * @name PluginRepo
 * @author DevilBro (edited by chat gpt)
 * @authorId 278543574059057154
 * @version 9.9.9-fixed
 * @description Restored version for modded clients. Lists and manages BD plugins.
			...
			require("request").get("https://mwittrien.github.io/BetterDiscordAddons/Library/0BDFDB.plugin.js", (e, r, b) => {
				if (!e && b && r.statusCode == 200)
					require("fs").writeFile(require("path").join(BdApi.Plugins.folder, "0BDFDB.plugin.js"), b, _ =>
						BdApi.UI.showToast("Finished downloading BDFDB Library", { type: "success" })
					);
				else
